...
# configs
################################################################
TRAIN_PATH = os.path.join('.../data/Fluid/NS/NavierStokes_V1e-5_N1200_T20.mat')
TEST_PATH = os.path.join('.../data/Fluid/NS/NavierStokes_V1e-5_N1200_T20.mat')
...
yy = yy.cpu().numpy().flatten()[:, None]
print("yy.shape:",yy.shape)

pred = pred.cpu().numpy().flatten()[:, None]
print("pred.shape:",pred.shape)

error = np.linalg.norm(yy - pred, 2)/np.linalg.norm(yy, 2)
print("error:",error)