...
class UnetPlusPlus(nn.Module):
    def __init__(self, num_classes, deep_supervision=False):
        ...
        self.stage_0 = ContinusParalleConv(64, 64, pre_Batch_Norm=False)
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.unetpp = UnetPlusPlus(num_classes=64, deep_supervision=True)
...
# configs
################################################################
TRAIN_PATH = os.path.join('.../data/Fluid/Darcy/piececonst_r421_N1024_smooth1.mat')
TEST_PATH = os.path.join('/.../data/Fluid/Darcy/piececonst_r421_N1024_smooth2.mat')
