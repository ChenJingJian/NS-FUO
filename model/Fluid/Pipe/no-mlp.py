...
class UnetPlusPlus(nn.Module):
    def __init__(self, num_classes, deep_supervision=False):
        ...
        self.stage_0 = ContinusParalleConv(48, 64, pre_Batch_Norm=False)
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.unetpp = UnetPlusPlus(num_classes=48, deep_supervision=True)
...
# configs
################################################################
INPUT_X = os.path.join('.../data/Fluid/Pipe/Pipe_X.npy')
INPUT_Y = os.path.join('.../data/Fluid/Pipe/Pipe_Y.npy')
OUTPUT_Sigma = os.path.join('.../data/Fluid/Pipe/Pipe_Q.npy')
