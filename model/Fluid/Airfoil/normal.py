...
# configs
################################################################
INPUT_X = os.path.join('.../data/Fluid/Airfoil/NACA_Cylinder_X.npy')
INPUT_Y = os.path.join('.../data/Fluid/Airfoil/NACA_Cylinder_Y.npy')
OUTPUT_Sigma = os.path.join('.../data/Fluid/Airfoil/NACA_Cylinder_Q.npy')
