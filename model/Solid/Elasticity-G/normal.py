...
# configs
################################################################
INPUT_PATH = os.path.join('.../data/Solid/Elasticity-G/Random_UnitCell_mask_10_interp.npy')
OUTPUT_PATH = os.path.join('.../data/Solid/Elasticity-G/Random_UnitCell_sigma_10_interp.npy')
